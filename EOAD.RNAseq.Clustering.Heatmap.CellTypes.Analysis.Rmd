...
###############################################################################################
#Determine neuron proportions (inhibitory, excitatory, astrocytes, endothelial, microglia, oligodendrocytes, oligodendrocyte precursor, neurohypophyseal and immature cells from all cell types) from all filtered genes  
###############################################################################################
...
```{r}
#Subset counts into only batch corrected endothelial cell genes
#Merge two data frames by ID
